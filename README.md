...
port: **8083** <br>
DB must be running (run through ```docker-compose-local.yml``` - part of project) <br>

## Swagger

When app runs in ```local``` profile, swagger is accessible on [http://localhost:8085/swagger-ui/index.html](http://localhost:8085/swagger-ui/index.html)
=======
...
- [ ] [Set up project integrations](https://gitlab.namcz.local/nam/nt/team3/1box-portal/development/start/context-service/-/settings/integrations)
